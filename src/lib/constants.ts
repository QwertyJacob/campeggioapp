export const DATE_DISPONIBILI = [
  { id: "2026-07-13", label: "Lunedì 13 luglio" },
  { id: "2026-07-14", label: "Martedì 14 luglio" },
  { id: "2026-07-15", label: "Mercoledì 15 luglio" },
  ...
  { id: "2026-07-24", label: "Venerdì 24 luglio" },
  { id: "2026-07-25", label: "Sabato 25 luglio" },
]
